...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2_5_vl_7b_AITutor_SFT+Vanilla_RL \
    trainer.n_gpus_per_node=4 \
    worker.reward.reward_type="batch" \
    worker.reward.reward_function="EasyR1/my_reward_functions/vanilla_reward.py:calculate_vanilla_reward_batch" \
